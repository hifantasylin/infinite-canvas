                    ...
                    <Dropdown
                        ...
                        menu={{
                            items: [
                                ...
                                // Roubaai fork: the upstream docs site is not part of a
                                // hosted canvas, so its entry is not offered.
                                ...(hosted ? [] : [{ key: "docs", icon: <BookOpen className="size-4" />, label: t("canvas.docs"), onClick: () => window.open(DOCS_URL, "_blank", "noopener,noreferrer") }]),
