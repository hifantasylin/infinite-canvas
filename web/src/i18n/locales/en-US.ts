export default {
    ...
    assets: {
        title: "Asset Library",
        description: "Browse every project's assets in the workspace: by project, category, type, or keyword.",
        search: "Search asset name, project, or category",
        searchAction: "Search",
        type: "Type",
        typeAll: "All",
        project: "Project",
        ...
        scopeGlobal: "Shared library",
        readOnly: "The shared library is read-only; import a copy into this project if you need one",
        projectSummary: "{{count}} assets · {{size}}",
        uncategorized: "Uncategorized",
        emptyLibrary: "No assets in this workspace yet",
        emptyLibraryHint: "Generated results land in .assets on their own; “Add asset” puts one there by hand.",
        refresh: "Refresh",
        exportSelected: "Export selected",
        selectedCount: "{{count}} selected",
        clearSelection: "Clear selection",
        chooseProject: "Which project should this go into?",
        move: "Move",
        moveTitle: "Move into which project?",
        moved: "Moved {{count}} item(s)",
        moveFailed: "Move failed",
        remove: "Delete",
        removeTitle: "Delete the {{count}} selected asset(s)?",
        removeHint: "The files are removed from disk and this cannot be undone; the project's landing record stays.",
        removed: "Deleted {{count}} item(s)",
        ...
        detailSource: "Landing record",
        detailSourceNone: "No landing record (uploaded by hand or placed from outside)",
        detailOrigin: "Origin",
        detailOriginNone: "Not recorded",
        detailCost: "Related cost",
        detailCostNone: "No related cost record",
        detailCostValue: "{{count}} run(s) · ${{cost}}",
