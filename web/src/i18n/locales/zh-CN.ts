export default {
    ...
    assets: {
        title: "资产库",
        description: "浏览工作区里的全部项目资产：按项目、类别、类型或关键词查找。",
        search: "搜索资产名、项目或类别",
        searchAction: "搜索",
        type: "类型",
        typeAll: "全部",
        ...
        projectAll: "全部项目",
        scope: "范围",
        scopeWorkspace: "本工作空间",
        scopeGlobal: "全局库",
        readOnly: "全局库只读；需要的话用「导入到本项目」把文件复制过来",
        projectSummary: "{{count}} 个资产 · {{size}}",
        uncategorized: "未归类",
        emptyLibrary: "工作区里还没有资产",
        emptyLibraryHint: "生成结果会自动落进 .assets；也可以用「新增资产」放进去。",
        refresh: "刷新",
        exportSelected: "导出选中",
        selectedCount: "已选 {{count}} 项",
        clearSelection: "清空选择",
        chooseProject: "放进哪个项目？",
        move: "移动",
        moveTitle: "移动到哪个项目？",
        moved: "已移动 {{count}} 项",
        moveFailed: "移动失败",
        remove: "删除",
        removeTitle: "删除选中的 {{count}} 项资产？",
        removeHint: "文件会从磁盘上移除，无法撤销；所在项目的落盘记录会保留。",
        removed: "已删除 {{count}} 项",
        removeFailed: "删除失败",
        rename: "重命名",
        renameTitle: "重命名为",
        ...
        detailModified: "修改时间",
        detailSource: "落盘记录",
        detailSourceNone: "没有落盘记录（手工上传或外部放入）",
        detailOrigin: "原始地址",
        detailOriginNone: "未记录",
        detailCost: "关联成本",
        detailCostNone: "没有关联的成本记录",
        detailCostValue: "{{count}} 次 · ${{cost}}",
